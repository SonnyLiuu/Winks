...
sensitivity = 4  # Adjust for more/less cursor movement
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            # Invert the movement for better control
    ...
    cv2.putText(frame, f"Cursor Sensitivity: {sensitivity}", (50, 250), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2)

    # Show frame
    cv2.imshow("Head Tracking & Blink Detection", frame)
